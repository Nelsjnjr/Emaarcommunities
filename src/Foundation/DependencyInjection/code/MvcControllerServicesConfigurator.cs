...
#endregion
namespace EMAAR.Emaarcommunities.Foundation.DependencyInjection.Infrastructure
{
    ...
    public class MvcControllerServicesConfigurators : IServicesConfigurator
    {
        ...
        public void Configure(IServiceCollection serviceCollection)
        {
            ...
            //All controllers and service attributes

            serviceCollection.AddMvcControllers("*.Feature.*", "*.Foundation.*");
