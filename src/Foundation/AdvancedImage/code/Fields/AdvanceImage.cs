...
namespace Sitecore.Shell.Applications.ContentEditor
{
    ...
    {
        private const string THUMBNAIL_FOLDER_FIELD_NAME = "thumbnailfolderid";
        private const string IS_DEBUG_FIELD_NAME = "IsDebug";
        private const string ASSETS_FOLDER_NAME = "Assets\\Project\\Emaarcommunities\\Fields\\AdvanceImage\\";
